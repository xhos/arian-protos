...
here lie `.proto` files used across nagomi for gRPC communication.
...
```shell
git submodule add -b main git@github.com:xhos/nagomi-protos.git proto
git commit -m "Add nagomi-protos as submodule at proto/"
```
